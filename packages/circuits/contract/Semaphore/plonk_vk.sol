// Verification Key Hash: 8c6f8ca07d18f837e4578b6c1bc082ffa08469f6a8a8a3b8d2953cda6b5776d5
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x8c6f8ca07d18f837e4578b6c1bc082ffa08469f6a8a8a3b8d2953cda6b5776d5;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x16624e55944b88195c9ae9acc866233a44fb16316630214dd043f7262685de59) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x0db8e8d28547381b92acc0eb5a2a3cb39b998a4f1ede48e95d22383b85c31bd9) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x2018bbdec22319c7e02e0ed3d2a667be88fda655ce46d6f7e78ac2aa3ab19f27) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x2e414ed57648f77a5305172c2003df3c57f2224fdb0f835c3eace26546b8377a) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x1b64d3a38b829b43ab397a06244fd9dad70208c951564d4eb64780b86e866fa4) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x0e4c888c0e50a93ad0cd74a8c18442c275773467d97810a1970e2c8c81aee81a) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x08ed68434c7511fde629ce9c27ab8972cb94a52ad4b3231406d807d31e5b16ac) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x295684ac343cda5121bff2a3448e901dd362cd440fbe7bc9114df2de96c2c09e) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x234be2e6193e1c85bc948bfb6e6d94b3d3ea199e4b0f19ecabde181b8938c1f7) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x27a18e20e6e473c88b21abd2b0884810f4db0a85df4c557fc308905c9555687b) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x0562f60f1831c209afd48912d99f01217de234dfdd8d61fe94967595dbd71374) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x23f72af1b933a2d4c3be4a8029b0738bc4255d2c69af7f7decb4c7d61c74a76c) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x26b529577d51d4f2a6424b1769875797cc582db8297dde8acecfacbe964f5559) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x11449c239ce753e7e3ddbd84fcdb68825245eefde91d45d9c5e05e69c22fad19) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x2ec6d640cdff11617f3111ab8689c372ac7725990996ac40459791395fae3d10) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x2111f6dcd2c5dca5dc04acc2c6fea25c4b05e81903b5251264106920034eb29a) // vk.QSORT.y
            mstore(add(_vk, 0x280), 0x2442c8ca769bc75e573710a885bad4a11767e0e4fba767b8e7a24c8448aa83d7) // vk.Q_ELLIPTIC.x
            mstore(add(_vk, 0x2a0), 0x00ac74e6a18261b028ceab145c7d5105f73038845807fcdde4d135de82939a0e) // vk.Q_ELLIPTIC.y
            ...
            mstore(add(_vk, 0x300), 0x043b8643d7fe3a72cf26367057d63d03ed46a0c60cf8c47e89fc16f259fb9c26) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x056d35c9ddec6236658837137d0dd9baa60c1a03f91d2d00001f61c53bde8ce3) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x23f94030c1df9ad12c741d4da7dd62add88b1403d8dee0583d8898d04c527f71) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x25cc822f9582dd5b219b70e20599cfd5bc2c6e64a9f65ec268ad7ec2dc6ea7ba) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x1bd9c68e311b446f0f81726f8199019bf821efe3ecfff15e8dc81b026d701071) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x2a0482a7f199deea75a10ef47d8cb022518ce01b0d08a6699d935b64683930dc) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x03ff6ae5182569f30fc6e72cb40ca7ed9a5b4d880f68bcf1b17018d131c4594f) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x2f507057940307fd5b26cfaaf22469bc37d660d205f6f618aa17da33ab18b46e) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x01c6b42d48f560f7c97a6e0f1694613f3a8e22003290fccd04db9e6f2aa9bbe5) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x2ea2538257053385a523427f83d49b947e1b2ee6cdf07a960ce2ed38ea91105c) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x2beb6cef4f3149445172b6ba4b834c82ec8079922f01310fb8a8c5f96b928a1d) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x17a915b72a1dac369c96cc3c1d9a944df0048c1b4c5a4eeeb99da3261e878824) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x0ebd524ed436d95c896f94a3bb854df6a80321e766184c868c1d4baab6abf26d) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x29b4618717f7cc03e8a5b0b6c45985254337f8026322551b37acca96177ccf79) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x09daa11455eed2b12e7a3d32f6a1b4ecb8a748fdf4c69788d07ac1f3d3e89dcb) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x2ea422e315a1f41df5f747ecf8a7114d2df17905f2beea98fb00c0c651cd0b5d) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x098049d32515405ca998c274b27a98bdf7876280cc1648368d2e7aeb5499ba92) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x14a7d6d9dd3ac19f2ea85efe890daa762bef8362b94287e249fb66fe722c24a3) // vk.ID4.y

// Verification Key Hash: 92dd42c365ef587bc6c5e0ccfaf896c4862fa48886f72ecfd43a17f96321233d
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x92dd42c365ef587bc6c5e0ccfaf896c4862fa48886f72ecfd43a17f96321233d;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x0a260497fca9d087e26c4aefe0ae70bca09c6f186b801787b86b4baa64449e9e) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x12bc5f3fddacf3f3a1cfe403b2a0ecf6a854e1b737f53606520b374510c2bbf8) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x2a1cb13b688ce13b42bfa77b5170deb81bd199f4352bda399fac9bb45b25a21b) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x1e3fd193cf1fc1655fe39c275dd5180925371078ffc97b23ff84c3b75a1506f5) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x2a8b28016138b9228db460416082305433c96d853c84a2fe047892de3c44bc86) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x1f81eb8fcaa2a47fb546238637133474e4d7b3e8b6800c3c7fb86bc68674b1bd) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x168f38de10771fa79a43d3bcb0c32159a1b8aa66835a03feb15330dfc64f00aa) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x24572b5e84efb16234df2e8e7dea909d48728a7b868bd5f6b9f975a83c61e581) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x1832eaee32129e964b3c9e89305e1c981378742f29eb7a521e694cf2d707e8c3) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x0e39dbeac96174d6a7b9f0fed001da422507ec026212f412c57201d6857e3f5a) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x10da2ef9ebc23e041b86020d9ea162c58ad7f262db38634a83a1be2530700a4c) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x241221e52f1d07773e388e7a198b91a6aaf2e69ccbb61478928686bc504f921c) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0d65ad4523385b756cbc323ae94eeb4bea683db7630d28cdfc54717cb0a843dd) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x19e9793e9928b4b93b98d3e2700487417bac6fa3d2a087fd1fadbe2f0be2905c) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x094f6bd31bcf241ec3e65ee5b89bab04079765311943fdbef79f9e94dc8439ac) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x17831f37df13c9df2abc28149199401d9f69b9a9921723bbca912c4d922f8ac1) // vk.QSORT.y
            mstore(add(_vk, 0x280), 0x0fd3add6d2c90c2d53461e92c1c3446cbb31804eef20a54209af1c06ba1a1f70) // vk.Q_ELLIPTIC.x
            mstore(add(_vk, 0x2a0), 0x05eae246669f4cc0adc0f42a4c9cad34f81924c08a38173cfc23c3641cb5635e) // vk.Q_ELLIPTIC.y
            ...
            mstore(add(_vk, 0x300), 0x044410161fb17c46df9f60a0c94db48890a030e313ada519b9ac5c176c791958) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x1a970e3275e7fad7aab24aeb31ba7678ddfa82dd6956ece4ddd35ae7f38dcc7b) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x3025a974066b44d9590ceb6aa5040c28aee61d962277e73080b4d48bd8bc3f55) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x1f121abc5bf27dff62ca7204f9c3fe8869d4d36fee92e0cea04316165c5d6a62) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x03c1f087ef582265cf4276f858876b3f3e6ecb4a1d4c521e76501223e7c46f37) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x1e7cc9122dd2a666a94274cb379e60d4489ff5c8bd1d345489c7c284c5f12068) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x284f95aa5da4a787a5001a3d264d4ed28338a5872c5d61f77862a757f477ae19) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x21f7ed038c4d2aacd1fe13dd6c621561eb5f2cab8ccfebfcc782df12da297234) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x207df1925953d12ee95c1bf927b108aa02081271a996e4288cda43889e772cf9) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x26ba3138931ec8832fc1e71982f1315d502e6a9c04459cb3bfdb5d4f35c6998e) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x274a5739df2efc631244312b77d187ded4f3d349395278d1376baaf8d6271a4a) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x138f3d11a0800ac1bebce26fb0af2659389934972fab1ee497b4aa3209e8bbef) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x065d30bb9bb7f48a286223fbe6fe742b073a35dbaff67ff8bc2f55c4741deee6) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x0f50d8f47c83b6c23a69a397076085aa8cc037314e1eaafe4d8f2ad602ebd912) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x1f3ace2c3d493e525b08d1358dd72ec9f5948f961abb3b94986d5101a73a2361) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x21970480548ae3d652137ec2965ddb4ed537d078ae11dc49265d4d73d190c2d4) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x1d0a8bcdc4b1b270d89c746c9142e87140504739094164ed58b88e3efebc0471) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x025a0e872f7162d6648ed60e36c794f7c28b329bf9f487191c1f21c411d8a1c8) // vk.ID4.y

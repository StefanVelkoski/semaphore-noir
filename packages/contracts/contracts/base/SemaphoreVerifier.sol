// Verification Key Hash: bf0b3acc4df14cb1210e6fe4f758d96db70a1bfa6c49fe5b08e20e7e9dd108b7
...
library UltraVerificationKey {
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1121110d129e3f4f32e4e06c757d1b1a0248c7073715f18ef70e6251b989f511) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x0a993584194b6a46d118c734a6b2c660f5d35a236e7192b47f25cc0ed2dac371) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x107dcb09c55ee94fe48fa56de169975c7ce0a40f99d5ed23ef6b46454364ab9a) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x11945055e0e3a750d841626c0dfdd63e586bb1b56e7f95383e1f2537e7ccc9b7) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x094f8c2f73528f2c5200b39c1c3d048d44c4eec65c1a2684e5c2d18dbfd9cfbe) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x250d2e5ebb46b9868f6b9ea3cdaa01c91b9183700fc89958161052d6ab29681a) // vk.Q3.y
            ...
            mstore(add(_vk, 0x180), 0x2b0a48471618497cc012e79db83d3ce676ed29c3f47142368b6706b3d75524a1) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x2449969608d32a9f80107b0aabf18b9720ed230bdf65d8840dc41f55ba7e7419) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x0f3c45e062107c850cefcf0638a845312de1c96d44d8d9ea377f1ea928e23f06) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x28c0bfc111c51d55c1b2a7f0a2d147bafd3ea89c76b666555fb8d4d3cc1daf81) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x0657e37c884d69641f17772c4999d7e61c47daa38f7319436b561de0aa61d603) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x130af647d4c1131e8bf7671c2db8d190fc3f511aeb5b665d4e6bcdfcee38d5d1) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x1b67d8008f6d5cf6217b4f3aa445cfc73011a95f1f226efdcffb8b052d480e2e) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x1bb41c5c3113e56b7da40bb848f5dd85c07b191d088e78f9ce7fb834dd364dfa) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x300), 0x09a0f8d4319dc5840b3d99c95b621d9bf80209a7ac9d48744400ba9a1cd3b3ca) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x100949de059b1c07e0e03914e9b6ac6115ea47be59c335ce25cc89559c688140) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x12bc48072ee6a478380a7ecd68d2a83ba78f96a36577256cc5cfe94ebd9c878b) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x08836fcb68010c79cd371a7c6f4a4d02d0b4188105a31f205e5c2684dce91037) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x18692b15ca34f9184dc0f97a96751d070eefb8eb6d2dc6e62a526845f07f28c2) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x0ca45764ed10c9423469dc24c6c12db8dfffc1f6724ac2f77b100c9bc94a1a0c) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x2376e8d5061972afef5e085165f8e0eb408a4915de646edcb689ed9a9c848f63) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x2d9bb0d10472142b44da0a878b0de718265450f317326bf8fad09e0779787150) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x540), 0x111ddde3cfba92b55b6bd86fd97af135bf32d36b8ac09ecf75c8248636ce40a2) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0bdbd37aa7537a0544c282f1aac45383a08866ad870693525a42158e726aa5ef) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x197cc78a36213c21bd4abb7a0ae5d3957e6c7714606acbd912fb503723959cb1) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x2789d5197f606392dfd1f32a3501c0fde95179dd8ceace29bf719e511679982a) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x2a2327f96c84eb402a515264906e8c1d2cba3a337f8c57f492d87453738e9c81) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0991a6e87d6ba72033a4a192bc9c9c5a557ece64411fc46b155a3aed15fa0d7b) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x1d812fb5eecf953ac21da984a92b43fc4caa79fcb520c255ff7743a60dbbe049) // vk.ID4.x
